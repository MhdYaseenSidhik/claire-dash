                ...
                {pr_suggestions.map((r: any, i: number) => (
                  <tr key={r.Material_Code}
                    style={{
                      ...
                      background: r.Criticality === "Critical" ? "rgba(6,182,212,0.04)" : i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.02)"
                    }}
                    onMouseEnter={e => (e.currentTarget.style.background = "rgba(6,182,212,0.08)")}
                    onMouseLeave={e => (e.currentTarget.style.background = r.Criticality === "Critical" ? "rgba(6,182,212,0.04)" : i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.02)")}
                  >
