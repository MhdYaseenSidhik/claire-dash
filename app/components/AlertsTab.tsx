              ...
              <tbody>
                {overstock.map((m: any, i: number) => (
                  <tr key={m.Material_Code}
                    ...
                    onMouseLeave={e => (e.currentTarget.style.background = m.Excess_Value_INR >= 100000 ? "rgba(239,68,68,0.04)" : m.Excess_Value_INR >= 50000 ? "rgba(245,158,11,0.04)" : i % 2 === 0 ? "transparent" : "rgba(255,255,255,0.02)")}
                  >
